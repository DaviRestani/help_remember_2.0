...
List _dataDummy = [
  {
    ...
    "thumbnailUrl": "assets/icons/Harry.png",
    "parente": "Amigo",
    "data": "10/04/23",
    "group": "g"
  },
...
class EditMedicineScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: GroupListEditMedicine(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class GroupListEditMedicine extends StatefulWidget {
  @override
  State<GroupListEditMedicine> createState() => _GroupListEditMedicineState();
}

class _GroupListEditMedicineState extends State<GroupListEditMedicine> {
