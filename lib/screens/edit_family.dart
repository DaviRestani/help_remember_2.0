...
class EditFamilyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: GroupListEditFamily(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class GroupListEditFamily extends StatefulWidget {
  @override
  State<GroupListEditFamily> createState() => _GroupListEditFamilyState();
}

class _GroupListEditFamilyState extends State<GroupListEditFamily> {
