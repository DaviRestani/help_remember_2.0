...
class Game {
  ...
  void onCardPressed(int index) {
    ...
    List<int> selecetedCardIndexes = _getSelectedCardIndexes();

    if (selecetedCardIndexes.length == 2) {
      CardItem card1 = cards[selecetedCardIndexes[0]];
      CardItem card2 = cards[selecetedCardIndexes[1]];
